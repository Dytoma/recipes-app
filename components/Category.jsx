    ...
    return (
        <div className=' font-poppins hide'>
            <Link href={`/categories/${category?.strCategory}`}>
                <motion.img initial={{opacity: 0, x: '-100%'}} whileInView={{opacity: 1, x: 0}} transition={{duration: 0.5, ease: 'easeInOut'}} src={category?.strCategoryThumb} alt={category?.strCategory} className='w-full rounded-lg h-[180px] object-cover bg-textLight dark:bg-darkModeBg hover:opacity-50 smooth_transition' />
            </Link>
