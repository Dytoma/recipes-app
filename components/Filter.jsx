...
const Filter = ({ children }) => {
    ...
    return (
        <div className='fixed inset-0 z-[100]'>
            ...
            >
                <button type='button' className='grid place-items-center p-3 rounded-full bg-slate-200 dark:bg-darkRed absolute md:top-9 md:right-9 top-5 right-5 hover:opacity-50' onClick={() => setSearchbar(false)}>
